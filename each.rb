...
#Use weather as variable name for each element in weather_options
weather_options.each do |weather|
  #Print what the weather is like using the current element.
...
#Use w as the variable for each element in words and iterate thorugh the array
words.each do |w|
  #Check if the current element has a length of 3 and print it if it does
  if w.length() == 3
    puts w
  end
end
